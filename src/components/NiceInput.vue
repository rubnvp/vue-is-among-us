...
.nice-input {
  ...
  input{border: 1px solid #ccc; padding: 7px 14px 9px; transition: 0.4s;}
  input ~ .focus-border:before,
  input ~ .focus-border:after{content: ""; position: absolute; top: 0; left: 0; width: 0; height: 2px; background-color: #4caf50; transition: 0.3s;}
  input ~ .focus-border:after{top: auto; bottom: 0; left: auto; right: 0;}
  input ~ .focus-border i:before,
  input ~ .focus-border i:after{content: ""; position: absolute; top: 0; left: 0; width: 2px; height: 0; background-color: #4caf50; transition: 0.4s;}
